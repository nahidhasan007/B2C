...
class ProfileMainFragment : BaseFragment<FragmentMainProfileBinding>() {
    private val viewModel by lazy {
        ProfileMainVMFactory(MainDataManager.getSharedPref(requireContext())).create(
            ProfileMainViewModel::class.java
        )
    }



    override fun layoutId(): Int = R.layout.fragment_main_profile
