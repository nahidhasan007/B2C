...
open class SingleDateCalendarFragment : BaseFragment<FragmentSingleCalendarBinding>() {
    ...
    private var visaStartDateSelected = false
    private var visaStartDate = ""
    ...
    override fun initOnCreateView() {
        ...
        if (mBundle != null) {
            ...
            visaStartDate = calenderData.visaStartDate
            visaStartDateSelected = calenderData.isVisaStartDateSelected
        ...
        visaApplicationStartingDate = if (visaStartDateSelected)
            LocalDate.parse(visaStartDate).plusDays(1)
        else
