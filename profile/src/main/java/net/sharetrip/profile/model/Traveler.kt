...
data class Traveler(
    ...
    fun isTravelerAgeValid(): Boolean {
        val dob = DateUtil.parseApiDateFormatFromDisplayCommonDateFormat(dateOfBirth)
        return DateUtil.getAge(dob) <= DateUtil.MAX_VALID_AGE
    }

    fun isValidPassport(): Boolean {
        return passportNumber.isPassportNumberValid()
    }
}
