...
class ProfileMainViewModel(val sharedPrefsHelper: SharedPrefsHelper) : BaseViewModel() {
    ...
    fun onClickReferAndEarn() {
        profileEventManager.clickReferEarn()
        profileAction = ProfileAction.ARG_REFER_EARN
        goToProfileDetails.value = Event(true)
    }

    fun onClickSavedCards() {
        profileAction = ProfileAction.ARG_SAVED_CARDS
        goToProfileDetails.value = Event(true)
    }

    fun onClickQuickPick() {
        profileEventManager.openFavGuestList()
        profileAction = ProfileAction.ARG_PASSENGERS_QUICK_PICK
        goToProfileDetails.value = Event(true)
    }

    fun onClickChangePassword() {
        profileAction = ProfileAction.ARG_CHANGE_PASSWORD
        goToProfileDetails.value = Event(true)
    }
    ...
    fun onClickPrivacyPolicy() {
        profileAction = ProfileAction.ARG_CONTENT_PRIVACY
        goToProfileDetails.value = Event(true)
    }

    fun onClickFaq() {
        profileAction = ProfileAction.ARG_FAQ
        goToProfileDetails.value = Event(true)
    }

    fun onClickTermAndCondition() {
        profileAction = ProfileAction.ARG_CONTENT_TERM
        goToProfileDetails.value = Event(true)
    }

    fun onClickManageData(){
        profileAction = ProfileAction.ARG_MANAGE_DATA
        goToProfileDetails.value = Event(true)
    }
