...
class ItemTraveler : Parcelable {
    ...
    var travelInsurance: TravelInsurance? = null
    var baggageInsurance: BaggageInsuranceBody? = null
    ...
    fun isDomesticPassportNumber(): Boolean {
        return passportNumber == "Domestic"
    }
}